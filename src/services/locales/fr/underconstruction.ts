const underConstruction = {
    ...
    errorEmailInvalid: "L’adresse email saisie ne semble pas valide. Merci de vérifier et de réessayer.",

    needHelp: "Vous avez besoin d’une assistance immédiate ?",
    bookAppointment: "Planifier un rendez-vous personnalisé",

    ctaNotify: "Notifier",
    ctaSending: "Envoi...",
    ctaSubscribed: "Inscrit !",
    sendErrorGeneric: "Erreur lors de l'envoi. Veuillez réessayer.",
};
