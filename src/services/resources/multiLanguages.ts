export const dictionary: any = {
  ...
  hero: {
    en: {
      title1: "MediaSmart",
      title2: "Relive, Share, Remember!",
      description:
        "Elevate Your Brand with MediaSmart: Captivating Videos, Memorable Stories.",
  ...
  testimonial: {
    en: {
      title: "What’s our customer say?",
      description:
        "Discover the impressions of our valued clientele on their MediaSmart experiences.",
      author1: "John Doe",
    ...
    fr: {
      ...
      description:
        "Découvrez les impressions de notre clientèle estimée sur leurs expériences avec MediaSmart.",
      author1: "John Doe",
