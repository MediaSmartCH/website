export const dictionary: any = {
  ...
  navbarHomepage: {
    en: {
      ...
      navbarButton: "Book a Appointment",
    },
    fr: {
      navItem1: "Accueil",
  ...
  contact: {
    ...
    fr: {
      ...
      invalidMobileError: "Veuillez entrer un numéro de mobile valide.",
      requiredEmailError: "L'email est requis.",
  ...
  hero: {
    en: {
      ...
      service2Button: "Explore Video Services",
    },
    fr: {
      title1: "MediaSmart",
  ...
  itOverview: {
    en: {
      ...
      exploreButton: "Explore More About IT Services",
    ...
    fr: {
      ...
      exploreButton: "En savoir plus sur les services informatiques",
  ...
  // À ajouter dans votre dictionnaire existant
  error404: {
    en: {
