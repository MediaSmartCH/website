...
const MEDIASMART_WEBSITE_URL = 'https://mediasmart.ch';
...
const i18n = {
  fr: {
    ...
    headerSub: 'Demande reçue via le formulaire de contact',
    intro: 'Nouveau message reçu depuis le site :',
    labelName: 'Nom',
    labelEmail: 'Email',
    ...
    confirmHeaderSub: 'Merci de nous avoir écrit',
    confirmGreeting: (name) => `Bonjour ${name},`,
    confirmBody: 'Nous avons bien reçu votre message. Nous vous répondons dans les meilleurs délais.',
    confirmCopy: 'Récapitulatif de votre message :',
    confirmNote: 'Cet email a été envoyé automatiquement : merci de ne pas y répondre directement.',
    confirmFooter: 'MediaSmart',
  },
  en: {
    subject: (name) => `New message from ${name}`,
    confirmSubject: 'We received your message - MediaSmart',
    headerTag: 'New message',
    headerSub: 'Request received via the contact form',
    intro: 'New message received from the website:',
    labelName: 'Name',
    labelEmail: 'Email',
    labelPhone: 'Phone',
    labelMessage: 'Message',
    ...
    confirmHeaderSub: 'Thank you for writing to us',
    confirmGreeting: (name) => `Hello ${name},`,
    confirmBody: 'We have received your message. We will get back to you as soon as possible.',
    confirmCopy: 'A copy of your message:',
    confirmNote: 'This email was sent automatically: please do not reply to it directly.',
    confirmFooter: 'MediaSmart',
  },
};
...
<p style="margin:0;font-size:11px;color:#3d3d5a;">${t.autoNote} <a href="${MEDIASMART_WEBSITE_URL}" style="color:#7c3aed;text-decoration:none;">mediasmart.ch</a></p>
</td></tr>
...
async function sendContactEmails(resend, payload, options = {}) {
  ...
  const hasConfirmError = confirm.error != null;
