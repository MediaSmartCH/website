  ...
  return (
    ...
    >
      ...
      <div className="mt-[20px] lg:mt-[40px] 2xl:mt-50px] lg:px-[50px] xl:px-[80px] 2xl:px-[120px]">
        ...
        */}
        <p className="text-center font-redDisplay font-light text-[14px] lg:text-[16px] xl:text-[17px] 2xl:text-[18px] text-[#FF4D00]">
          {dictionary["testimonial"][languageReducer]["noTestimonial"]}
        </p>
        {/* <TestimonialSlider
      ...
      <div className="px-[20px] mt-[60px] lg:mt-[80px] 2xl:mt-90px] lg:px-[90px] xl:px-[120px] 2xl:px-[160px]">
        ...
        <button className="hero-btn custom-btn w-full sm:w-auto min-w-[180px] h-[38px] lg:w-[200px] lg:h-[45px] xl:w-[212px] xl:h-[49px] rounded-[5px] text-[#fff] font-helvetica font-light text-[14px] md:text-[14px] xl:text-[15px] 2xl:text-[16px]">
