      ...
      <div className="w-full homepage-container px-[25px] md:px-[50px] lg:px-[50px] xl:px-[100px] 2xl:px-[160px] mx-auto pt-[50px] lg:pt-[75px] xl:pt-[75px] pb-[50px] relative">
        ...
        >
          ...
          <div className="w-full justify-center flex items-center gap-3 md:gap-5 flex-wrap px-[20px]"
            ...
            data-aos-easing="ease-in-sine"
          >
            <Link to={L("/it-services")} onMouseEnter={preloadITServices} onClick={() => window.scrollTo(0, 0)}>
            ...
            <Link to={L("/video-services")} onMouseEnter={preloadVideoServices} onClick={() => window.scrollTo(0, 0)}>
              <button className="hero-btn custom-btn w-full md:min-w-[150px] h-[38px] lg:min-w-[200px] lg:h-[45px] xl:min-w-[212px] xl:h-[49px] rounded-[5px] text-[#fff] font-helvetica font-light text-[14px] md:text-[14px] xl:text-[15px] 2xl:text-[16px] px-2">
                <span className="custom-btn-inner">
